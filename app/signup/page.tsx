...
import { useSignUp, useGoogleSignIn } from '@/lib/auth-hooks'
...
export default function SignUpPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-600/10 via-indigo-600/10 to-purple-600/10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-md w-full space-y-8">
        ...
        <div className="text-center">          
          ...
          <p className="text-gray-600">
            Join the AI Hiring Assistant platform
          </p>
        </div>
          ...
          <div className="card-content">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <button
                  type="submit"
                  disabled={signUpMutation.isPending || googleSignInMutation.isPending}
              ...
              <div>
                ...
                >
                  ...
                  {googleSignInMutation.isPending ? 'Signing up with Google...' : 'Continue with Google'}
                </button>
              </div>

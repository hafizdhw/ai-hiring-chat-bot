...
import { useSignIn, useGoogleSignIn } from '@/lib/auth-hooks'
      ...
      <div className="relative max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Sign in to your AI Hiring Assistant account
          </p>
        </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                >
                  ...
                  {googleSignInMutation.isPending ? 'Signing in with Google...' : 'Continue with Google'}
                </button>
              </div>
